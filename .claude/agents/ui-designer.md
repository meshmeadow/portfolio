---
name: ui-designer
description: "Use when updating the visual components of the website always"
model: inherit
color: pink
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/Users/shalmali.gaikwad@grofers.com/Desktop/project/portfolio/.claude/agent-memory/ui-designer/`. This directory already exists — write to it directly with the Write tool (do not run mkdir or check for its existence). Its contents persist across conversations.
